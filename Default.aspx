...
<body>
    <h3 style=" text-align:center;">特产信息征集</h3>
            ...
            <tr>
                <td class="style5">
                    ...
                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatColumns="3">
                        <asp:ListItem>味道美味</asp:ListItem>
